...
// Value is A JSON float64 or slice of Values, functions will panic if this is not true.
type Value = any

// List is a list of Values - A packet is a List
type List = []Value
...
func ParsePairs(input string) [][2]List {
	...
	for pairs := range strings.SplitSeq(input, "\n\n") {
